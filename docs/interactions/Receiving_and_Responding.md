...
| Field          | Type                                                                                                                                                                                   | Description                                                                                                                                         |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| id             | snowflake                                                                                                                                                                              | for slash commands, the [`ID`](#DOCS_INTERACTIONS_SLASH_COMMANDS/application-command-object-application-command-structure) of the invoked command   |
| name           | string                                                                                                                                                                                 | for slash commands, the [`name`](#DOCS_INTERACTIONS_SLASH_COMMANDS/application-command-object-application-command-structure) of the invoked command |
| resolved?      | [application command interaction data resolved](#DOCS_INTERACTIONS_SLASH_COMMANDS/application-command-interaction-object-application-command-interaction-data-resolved-structure)      | for slash commands, converted users + roles + channels                                                                                              |
| options?       | array of [application command interaction data option](#DOCS_INTERACTIONS_SLASH_COMMANDS/application-command-interaction-object-application-command-interaction-data-option-structure) | for slash commands, the params + values from the user                                                                                               |
